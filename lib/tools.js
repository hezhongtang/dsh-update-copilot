...
export async function registerCopilotTools(tools, ctx = null) {
  ...
  disposers.push(tools.register(defineTool({
    ...
    description: 'Build update highlights for one outdated item: semver distance, risk level, changelog material (versions, GitHub commits/release notes, or local git log), and a recommendation. Read-only. Use it to advise the user before updating.',
    parameters: {
