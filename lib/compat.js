...
/** Cache wrapper over the npm-pack target pass — the gate reuses the same
 * 10-minute TTL discipline (force bypasses and refreshes) so an update click
 * never re-packs what the scan just packed. */
