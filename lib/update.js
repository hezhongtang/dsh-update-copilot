...
import { attachRisks, snapshotAvailability } from './availability.js'
import { bundleNamesOf, classifySpec, clearScanCache, githubCommitKey, inferMountRelationships, installedVersion, linkedGitState, listProfiles, npmNewest, pinnedCommits, pluginMemberNames, profileDependencyMetadata, readDeps } from './scan.js'
...
export async function updatePlugin(profile, name, hooks = {}, options = {}) {
  ...
  return sealIntegrity(await runPnpmUpdate(profile, name, target, { reload, targetVersion, repoKey }), profile, name, beforeAvail)
}
