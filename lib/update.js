 ...
 */
export async function updatePlugin(profile, name, hooks = {}) {
  ...
  // code regardless of the package name it is linked as.
  if (kind === 'linked') return updateLinkedPlugin(profile, name, spec, hooks)
